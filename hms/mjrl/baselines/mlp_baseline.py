...
class MLPBaseline:
    ...
    def fit(self, paths, return_errors=False):
        ...
        featmat_var = Variable(torch.from_numpy(featmat), requires_grad=False).to(self.device)
        returns_var = Variable(torch.from_numpy(returns), requires_grad=False).to(self.device)
    ...
    def predict(self, path):
        ...
        feat_var = Variable(torch.from_numpy(featmat).float(), requires_grad=False).to(self.device)
